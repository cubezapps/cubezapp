...
export default {
  ...
  methods: {
    async init () {
      ...
      this.$WebSDK('common.registerNHotkey', 'clipboard', 162, false, 100)
      this.$WebSDK('common.registerNHotkey', 'clipboard', 164, false, 100)
      this.$WebSDK('common.registerNHotkey', 'clipboard', 86, false, 100)
